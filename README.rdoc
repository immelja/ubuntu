...
This project is also meant to serve as a prelude to the {Rails Setup Project}[https://github.com/bkuhlmann/rails_setup_template]
should you wish to have a bootstrapped Rails app running on fresh Ubuntu install with a full server stack.
